        ...
        <div>
          ...
          <div className="flex justify-between bg-amber-950  text-white px-8 rounded-tr-full ml-12">
            <div className="flex gap-2 p-3">
              <img src={experience} alt="" className="h-10 rounded-full p-1 bg-yellow-400" />
              <div>
                <h1 className="text-3xl ">15+</h1>
                <p className="text-sm text-gray-400">
                  Years of Experience <br /> – Shaping young minds with dedication and
                  care.
                </p>
              </div>
            ...
            <div className="flex gap-2 p-3">
              <img src={teacher} alt="icon"  className="h-10 rounded-full p-1 bg-purple-400"/>
              <div>
                <h1 className="text-3xl ">30+</h1>
                <p className="text-sm text-gray-400">
                  Skilled Teachers <br /> – Experts in academics, arts, and child
                  development.
                </p>
              </div>
            </div>
              <div class="border-l-2 border-white h-24 mt-2"></div>
            <div className="flex gap-2 p-3">
              <img src={teacher} alt="icon"  className="h-10 rounded-full p-1 bg-blue-400"/>
              <div>
                <h1 className="text-3xl">50+</h1>
                <p className="text-sm text-gray-400">
                  Extracurricular Activities <br /> – Sports, arts, music, and more.
                </p>
              </div>
            </div>
          </div>
